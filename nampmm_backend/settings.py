...
SECRET_KEY = 'django-insecure-z2j+pvn#$)-8ex3q#@u2(1gdn$z_4^a)=gvj@-51mqbx=rf*m4'
...
ROOT_URLCONF = 'nampmm_backend.urls'
...
WSGI_APPLICATION = 'nampmm_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('POSTGRES_SERVER', 'db'),  # 'db' is the service name in docker-compose
...
# Ensure Django recognizes HTTPS connections
